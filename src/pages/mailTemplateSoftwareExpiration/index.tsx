...
export default function TemplateSoftwareExpirationPage() {
	...
	const {
		...
		updateSuccessText: t('updateMailSoftwareExpirationSuccess'),
		updateErrorText: t('updateMailSoftwareExpirationError'),
		createSuccessText: t('createMailSoftwareExpirationSuccess'),
		createErrorText: t('createMailSoftwareExpirationError'),
	});
