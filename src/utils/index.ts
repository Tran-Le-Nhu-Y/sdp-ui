...
export enum RoutePaths {
	...
	DEPLOYMENT_PHASE = `${SETUP_DEPLOYMENT_PROCESS}/phase/:${PathHolders.DEPLOYMENT_PHASE_ID}`,
	SETUP_DEPLOYMENT_PHASE = `${SETUP_DEPLOYMENT_PROCESS}/phase/:${PathHolders.DEPLOYMENT_PHASE_ID}/setup`,
